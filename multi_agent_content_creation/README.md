...
-   `/trend_research_agent/`: **Agent 1:** Scans for trending topics using Google Trends.
...
-   **Agent 1: Trend Research Agent:** Identifies emerging trends by fetching daily trending searches from Google Trends. It then uses a Gemini LLM to generate a brief summary for each topic.
